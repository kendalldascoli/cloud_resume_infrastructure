...
resource "aws_s3_bucket" "test_static_website_bucket" {
  bucket = "test-website-static-bucket-kendall-dascoli"
...
resource "aws_s3_bucket_public_access_block" "test_static_website_public_access_block" {
